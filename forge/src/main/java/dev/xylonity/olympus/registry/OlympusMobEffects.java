...
public final class OlympusMobEffects {
    ...
    public static final DeferredHolder<MobEffect, InvisibilityOfHadesEffect> INVISIBILITY_OF_HADES = MOB_EFFECTS.register("invisibility_of_hades", InvisibilityOfHadesEffect::new);
