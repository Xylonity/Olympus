...
public final class SpearOfAresItemRenderer extends KnightLibItemRenderer {
    ...
    public static final ModelResourceLocation INVENTORY_MODEL = ModelResourceLocation.standalone(Olympus.of("item/spear_of_ares_item"));
    public static final ModelResourceLocation CHARGED_INVENTORY_MODEL = ModelResourceLocation.standalone(Olympus.of("item/spear_of_ares_item_charged"));
